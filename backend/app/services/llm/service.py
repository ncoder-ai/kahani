    ...
    async def _maybe_improve_semantic_scenes(
        ...
        try:
            ...
            decompose_task = (
                ...
                "Split this story continuation into separate search phrases for finding PAST scenes.\n"
                "Focus on references to PAST events, memories, or things that happened before.\n"
                "Current actions (what the character is doing RIGHT NOW) are less important — "
                "prioritize phrases about what characters RECALL, REMEMBER, or REFERENCE from earlier.\n"
                "Keep character names in each phrase. Return ONLY a JSON array (max 6 phrases).\n\n"
                "Example: \"Maya sits alone, remembering Ravi confronting her at the cafe and later apologizing at the park\"\n"
                "[\"Ravi confronts Maya at the cafe\", \"Ravi apologizes to Maya at the park\"]\n"
                "(Note: \"Maya sits alone\" is a current action, not included)\n\n"
                ...
                "Example: \"Lena walks home thinking about the hidden cameras she found in the bedroom\"\n"
                "[\"hidden cameras in the bedroom\", \"Lena discovers hidden cameras\"]\n"
                "(Note: \"Lena walks home\" is a current action, not included)\n\n"
