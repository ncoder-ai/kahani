...
def upgrade():
    ...
    # Add portrait_image_id to characters table
    op.add_column('characters', sa.Column('portrait_image_id', sa.Integer(), nullable=True))
    ...
    op.add_column('user_settings', sa.Column('image_gen_enabled', sa.Boolean(), nullable=True))
    op.add_column('user_settings', sa.Column('comfyui_server_url', sa.String(length=500), nullable=True))
    op.add_column('user_settings', sa.Column('comfyui_api_key', sa.String(length=500), nullable=True))
    op.add_column('user_settings', sa.Column('comfyui_checkpoint', sa.String(length=200), nullable=True))
    op.add_column('user_settings', sa.Column('comfyui_model_type', sa.String(length=50), nullable=True))
    op.add_column('user_settings', sa.Column('image_gen_width', sa.Integer(), nullable=True))
    op.add_column('user_settings', sa.Column('image_gen_height', sa.Integer(), nullable=True))
    op.add_column('user_settings', sa.Column('image_gen_steps', sa.Integer(), nullable=True))
    op.add_column('user_settings', sa.Column('image_gen_cfg_scale', sa.Float(), nullable=True))
    op.add_column('user_settings', sa.Column('image_gen_default_style', sa.String(length=50), nullable=True))
    op.add_column('user_settings', sa.Column('use_extraction_llm_for_image_prompts', sa.Boolean(), nullable=True))
...
def downgrade():
    ...
    op.drop_constraint('fk_characters_portrait_image_id', 'characters', type_='foreignkey')
    op.drop_column('characters', 'portrait_image_id')
