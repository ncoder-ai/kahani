...
| [docs/SECURITY_SETUP.md](docs/SECURITY_SETUP.md) | Securing your deployment for production |
| [docs/user-settings-guide.md](docs/user-settings-guide.md) | Per-user LLM/TTS settings system |
| [docs/per-provider-settings.md](docs/per-provider-settings.md) | Per-provider TTS configuration |
| [docs/text-completion-guide.md](docs/text-completion-guide.md) | Text Completion API guide |
