...
curl -X GET "http://localhost:9876/api/tts/provider-configs" \
  -H "Authorization: Bearer YOUR_TOKEN"

# Get specific provider config
curl -X GET "http://localhost:9876/api/tts/provider-configs/chatterbox" \
  -H "Authorization: Bearer YOUR_TOKEN"

# Save provider config
curl -X PUT "http://localhost:9876/api/tts/provider-configs/chatterbox" \
  -H "Authorization: Bearer YOUR_TOKEN" \
