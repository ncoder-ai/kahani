  ...
  return (
    <>
      ...
      <div className="fixed right-4 top-16 z-50 w-80 max-w-[calc(100vw-2rem)] theme-card border border-gray-700 rounded-lg shadow-2xl overflow-hidden">
        ...
        {/* Menu Items */}
        {/* 100dvh (dynamic viewport height) shrinks with iOS Safari's URL bar so
            the bottom items (logout) don't get hidden behind the toolbar.
            Subtracted amount = top-16 (4rem) + header (~4rem) + bottom safe-area
            buffer (~1rem) = 9rem. */}
        <div
