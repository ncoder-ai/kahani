  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold mb-3 text-white">Choose Your Story Mode</h2>
      ...
      <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        ...
        <button
          ...
          className={`p-8 rounded-2xl border-2 transition-all text-left hover:scale-105 relative ${
            selected === 'dynamic'
              ? 'border-2 shadow-lg'
        ...
        >
          ...
          <div className="flex items-start gap-4 mb-4 relative z-10">
            ...
            <div className="flex-1">
              <h3 className="text-2xl font-bold mb-2 text-white">Dynamic Mode</h3>
