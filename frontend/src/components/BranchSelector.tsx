...
export default function BranchSelector({
  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      {/* Dropdown menu */}
      {isOpen && (
        <div className="absolute top-full left-0 mt-1 w-64 max-w-[calc(100vw-3rem)] bg-slate-800 border border-slate-600/50 rounded-lg shadow-xl z-50 overflow-hidden">
          {/* Branch list */}
