          ...
          <div className="space-y-6">
              ...
              {selectedPresetId && (
                <div className="flex gap-2 sm:items-end">
                  <button
                    ...
                    className="flex-1 sm:flex-none px-4 py-2 theme-btn-primary rounded-md font-medium"
                  ...
                  <button
                    ...
                    className="sm:flex-none px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md font-medium"
                    title="Delete preset"
                  >
                    🗑️
                  </button>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="w-full sm:flex-1 theme-btn-primary px-6 py-3 rounded-lg font-semibold disabled:opacity-50"
              >
                {savingPrompts ? 'Saving...' : selectedPresetId ? 'Update Preset' : 'Save Preset'}
              </button>
              <button
                onClick={saveAsNewPreset}
                className="w-full sm:w-auto px-6 py-3 theme-btn-secondary rounded-lg font-semibold"
              >
                💾 Save As New
              </button>
              {selectedPresetId && (
                <button
                  ...
                  disabled={savingPrompts}
                  className="w-full sm:w-auto px-6 py-3 theme-btn-primary rounded-lg font-semibold disabled:opacity-50"
                >
                  Save & Activate
                </button>
              )}
