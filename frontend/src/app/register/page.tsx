...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen theme-bg-primary relative flex flex-col justify-center py-12 sm:px-6 lg:px-8 overflow-hidden">
      {/* Brand background — same full-bleed treatment as login. The
          background image itself contains the Kahani wordmark + book
          artwork, so we don't render a duplicate logo on top. */}
      <div
