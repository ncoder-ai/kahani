...
```
Frontend hot-reloads automatically. Backend code changes require a container rebuild.
...
### Prompts
- `backend/prompts.yml` - All LLM prompt templates (hot-reloaded, no restart needed)
